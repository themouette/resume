define({
    experiences: [{
        ...
        from: "2012-10-01",
        until: "2013-03-31",
        mission: "Develop a car retailer intranet and best practices evangelist.",
        logo: "itnetwork.png",
        description: [
            "Particiated in best practice introduction for development team as well as ",
            "PHP/Javascript developer.",
            "",
            "During my mission, team started to Unit Test PHP code, implement ",
            "[CasperJS](http://casperjs.org) strategies, do peer reviews...",
            "",
            "I also introduced [elasticsearch](http://www.elasticsearch.org/) , ",
